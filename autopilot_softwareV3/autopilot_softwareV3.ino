...
//elevator
bool rev1 = false;               // change to true/false, to reverse the levelling direction.
...
void loop() {
  ...
  // Write to the servos
  servo_elevator.write(180 - pos1);     // tell servo to go to position pos1 (in degree)
  servo_right_aileron.write(pos2);     // tell servo to go to position pos2 (in degree)
  servo_left_aileron.write(pos2);       // do the oposite of right aileron (pos2)
