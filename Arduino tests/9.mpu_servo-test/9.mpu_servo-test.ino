// making a servo react to the movement of the MPU
// the code added, to move the servo, was based off of the servo "Sweep" example by BARRAGAN <http://barraganstudio.com> (modified 8 Nov 2013, by Scott Fitzgerald, https://www.arduino.cc/en/Tutorial/LibraryExamples/Sweep).
...
// Settings:
float gain1 = 1; // int between 0 and 1 to control the how much the servo moves, for every degree of MPU rotation.
bool rev1 = true; // change to true/false, to reverse the servo direction.
...
void loop() {
  ...
  int pos1 = (beta + 90)*gain1;    // beta[-90°, 90°] ==> servo[0, 180]
  if (rev1 == true) {              // Reverse servo direction if rev1 is set to true
    pos1 = 180 - pos1;
  }
